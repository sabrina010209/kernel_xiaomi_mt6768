...
/*zpc add for combal awinic amp begain*/
static struct aw87xx_dev_t* aw87xx_dev = NULL;
/*zpc add for combal awinic amp end*/
...
/*zpc add for combol awinic pa begain*/
...
int ext_amp_poweron(int enable)
{
	...
	if(aw87xx == NULL) {
		...
		ret |= pr_info("ext amp use is aw87xx\n");
	}

	return ret;
}
EXPORT_SYMBOL(ext_amp_poweron);
/*zpc add for awinc simple pa end*/
...
/*zpc add for combol awinic pa end*/
