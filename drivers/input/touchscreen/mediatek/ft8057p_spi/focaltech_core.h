...
#if LCT_TP_INFO_EN
extern int lct_fts_get_tpfwver(const char *cmd);
#endif

#if LCT_TP_WORK_EN
extern int lct_fts_tp_work_callback(bool en);
#endif

#if LCT_TP_SELFTEST_EN
extern int lct_fts_tp_selftest_callback(unsigned char cmd);
extern int lct_tp_selftest_all(void);
#endif

#if LCT_TP_GRIP_AREA_EN
extern int lct_fts_tp_set_screen_angle_callback(int angle);
#endif
...
extern int lct_fts_tp_proximity_callback(bool enFlag);
