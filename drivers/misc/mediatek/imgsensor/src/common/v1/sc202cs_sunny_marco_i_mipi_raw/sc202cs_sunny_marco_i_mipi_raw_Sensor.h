...
#define SC202CS_VALID_IXEL_NUMS            800
#define SC202CS_VALID_LINE_NUMS            1200
#define SC202CS_DEFAULT_DUMMY_PIXEL_NUMS   0x11c //244 
#define SC202CS_DEFAULT_DUMMY_LINE_NUMS    0x0e //64

#define SC202CS_INTERNAL_DUMMY_PIXEL_NUMS  36
#define SC202CS_INTERNAL_DUMMY_LINE_NUMS   32

#define SC202CS_VIDEO_PERIOD_PIXEL_NUMS          (1120)
#define SC202CS_VIDEO_PERIOD_LINE_NUMS           (1246)
#define SC202CS_PV_PERIOD_PIXEL_NUMS            (1120)
#define SC202CS_PV_PERIOD_LINE_NUMS             (1246)

#define SC202CS_FULL_PERIOD_PIXEL_NUMS          (1120)
#define SC202CS_FULL_PERIOD_LINE_NUMS           (1246)
